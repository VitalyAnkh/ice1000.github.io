...
-- branches that passes `r` should be refactored.
-- `r` should be a custom GADT, not simply equality type.
...
printfImpl (x :: xs) [List] r = {!!} -- unimplemented
printfImpl (x :: xs) (y :: args) r = {!!} -- unimplemented
```
